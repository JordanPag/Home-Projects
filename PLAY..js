...
AddRow("office",["d","f","f","f","f","f","f","f","w","f","f","f","w","f","f","f","f","f","w","f","f","w","f","w","w","w","w","w","w","f","f","f"]);
...
AddRow("office",["f","f","f","w","w","w","w","w","w","w","w","w","w","d","d","d","w","w","w","w","w","w","w","w","w","w","w","w","w","w","w","f"]);
